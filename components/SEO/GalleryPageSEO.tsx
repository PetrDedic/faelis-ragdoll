...
const GalleryPageSEO = () => {
  ...
  const structuredData = [
    ...
    generateBreadcrumbSchema([
      ...
      { name: names.current, url: "https://www.ragdolls.cz/gallery" },
    ]),
  ];
  ...
  return (
    <SEO
      ...
      ogImage="/og.png"
      ogUrl="https://www.ragdolls.cz/gallery"
      ogType="website"
      twitterCard="summary_large_image"
      canonicalUrl="https://www.ragdolls.cz/gallery"
